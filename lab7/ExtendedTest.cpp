...
void testAllExtended() {
	...
	std::cout << "test create ok!\n";
	testAdd();
	cout << "test add ok!\n";
	testRemove(rLessEqual);
	cout << "test remove less ok!\n";
	testRemove(rGreater);
	cout << "test remove greater ok!\n";
	testIterator(rLessEqual);
	cout << "test iterator less ok!\n";
	testIterator(rGreater);
	cout << "test iterator greater ok!\n";
	testQuantity(rLessEqual);
	cout << "test quantity less ok!\n";
	testQuantity(rGreater);
	cout << "test quantity greater ok!\n";
